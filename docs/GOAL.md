...
この段階ではvector searchもGraph UIも不要。
...
この設計なら、Web記事、GitHub repo、論文、メモが全部同じパイプラインに乗ります。
しかも、100万件規模になっても「タグ爆発」「リンク爆発」「フォルダ破綻」をかなり抑えられます。
